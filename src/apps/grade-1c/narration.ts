...
const LESSON_DIRECTIONS: Record<string, string> = {
  ...
  "w2-finals": "Let's explore sounds! Listen, then copy the sound with your mouth. Tap Next when you're ready.",
  "w2-initials": "Let's learn starting letters! Look at the letter and listen. Tap Next when you're ready.",
